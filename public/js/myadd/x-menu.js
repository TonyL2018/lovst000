...
$(document).ready(function() {
    ...
    function sh_highlightString(a, b) {
        ...
        m = function(b, c) {
            ...
            if (l !== c) {
                ...
                if (c) {
                    var n;
                    c === "sh_url" ? n = f.cloneNode(!1) : n = g.cloneNode(!1),
                    n.className = c,
                    h[i++] = {
                        node: n,
                        pos: k
        ...
        while (k < o) {
            ...
            for (;;) {
                ...
                H = G[1],
                I;
                if (H instanceof Array) for (var J = 0; J < H.length; J++) I = B[J + 1],
                m(I, H[J]);
                else I = B[0],
                m(I, H);
                switch (G[2]) {
            ...
            l === "sh_url" && sh_setHref(h, i, a), l = null),
            k = r
        }
        return h
    }
    ...
    function sh_mergeTags(a, b) {
        ...
        while (f < c) e.push(a[f]),
        f++;
        while (g < d) e.push(b[g]),
        g++;
        return e
    }
    function sh_insertTags(a, b) {
        ...
        while (g < h || e < f) {
            ...
            if (k <= g) {
                ...
                e++
            } else i.appendChild(c.createTextNode(b.substring(g, k))),
            g = k
        }
        return d
    }
